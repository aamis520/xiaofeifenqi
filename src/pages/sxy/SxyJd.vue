				...
				<el-tabs type="border-card">
					...
					<el-tab-pane :label="luangeneedtobechange.shenpixinxi">
						...
						<div class="approval_form">
							<h3>{{luangeneedtobechange.shouxinyuanshenpi}}</h3>
							<el-form :model="approvalForm" ref="approvalForm" label-width="120px">
								...
								<el-form-item :label="luangeneedtobechange.shouxinjine + '：'" required>
									<el-input type="input" style="width: 400px;"  v-model="approvalForm.approval_amount"></el-input>
								</el-form-item>
								<el-form-item :label="luangeneedtobechange.shenpiyijian + '：'">
									<el-input type="textarea" style="width: 400px;" :rows="5"  v-model="approvalForm.approvalComment"></el-input>
								</el-form-item>
								<el-form-item>
		...
		methods: {
			...
			handleSubmit(){
				...
				self.$axios.post(url,{
					...
					approval_amount:self.approvalForm.approval_amount
				}).then(function(res){
					if(res.data.code == 0){
